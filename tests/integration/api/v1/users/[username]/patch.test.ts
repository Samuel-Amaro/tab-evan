...
describe('PATCH /api/v1/users/[username]', () => {
	describe('Anonymous user', () => {
		...
		it("With duplicated 'username'", async () => {
			const user1Response = await fetch('http://localhost:5173/api/v1/users', {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json'
				},
		...
		it("With duplicated 'email'", async () => {
			...
			const response = await fetch('http://localhost:5173/api/v1/users/email2', {
				method: 'PATCH',
				headers: {
					'Content-Type': 'application/json'
				},
		...
		it("With unique 'username'", async () => {
			...
			const response = await fetch('http://localhost:5173/api/v1/users/uniqueUser1', {
				method: 'PATCH',
				headers: {
					'Content-Type': 'application/json'
				},
		...
		it("With unique 'email'", async () => {
			...
			const response = await fetch('http://localhost:5173/api/v1/users/uniqueEmail1', {
				method: 'PATCH',
				headers: {
					'Content-Type': 'application/json'
				},
		...
		it("With new 'password'", async () => {
			...
			const response = await fetch('http://localhost:5173/api/v1/users/newPassword1', {
				method: 'PATCH',
				headers: {
					'Content-Type': 'application/json'
				},
